							...
							<div class="card-body">
								<div class="border p-4 rounded">
									...
									<div class="row mb-3">
										...
										<div class="col-sm-9">
											<input type="text" name="title" value="{{ $banner->title }}" class="form-control" id="inputEnterYourName" placeholder="Enter Banner Title">
										</div>
									</div>
									<div class="row mb-3">
										<label for="inputEnterYourName" class="col-sm-3 col-form-label">SubTitle</label>
										<div class="col-sm-9">
											<input type="text" name="subtitle" value="{{ $banner->subtitle }}" class="form-control" id="inputEnterYourName" placeholder="Enter Banner SubTitle">
										</div>
									</div>
									<div class="row mb-3">
										<label for="inputEnterYourName" class="col-sm-3 col-form-label">Links</label>
										<div class="col-sm-9">
											<input type="link" name="link" value="{{ $banner->link }}" class="form-control" id="inputEnterYourName" placeholder="Enter Banner Links">
										</div>
									</div>
									<div class="row mb-3">
									...
									<div class="row mb-3">
										...
										<div class="col-sm-9">
											<input name="image" type="file" value="{{ $banner->image }}" class="form-control" accept="image/*">
											<small class="text-muted">Upload image in jpg, jpeg, png format only.</small>
											@if($banner->image)
												<img src="{{ asset( 'uploads/bannerimages/' . $banner->image) }}" alt="Blog Image" class="img-thumbnail mt-2" style="max-width: 200px;">
											@endif
										</div>
									</div>
									<div class="row mb-3">
										...
										<div class="col-sm-9">
											<textarea id="editor" class="form-control" value="" name="description"> {{$banner->description}}</textarea>
										</div>
									</div>
									<div class="row">
