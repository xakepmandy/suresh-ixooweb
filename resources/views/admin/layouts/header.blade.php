...
<?php
 ...
 $contacts = contact::where('status', 'pending')->get();
      ...
      <nav class="navbar navbar-expand">
        <div class="topbar-logo-header d-none d-xl-flex">
            <div>
              ...
              <img src="{{asset('assets/images/ixooweb-logo-neww.png')}}"  class="logo-icon" alt="logo icon">
              </a>
            </div>
            {{-- <div>
              <h4 class="logo-text">Ixooweb</h4>
            </div> --}}
        ...
        <div class="mobile-toggle-icon d-xl-none">
          ...
          <ul class="navbar-nav align-items-center">
            ...
            {{-- <li class="nav-item">
            <a class="nav-link" href="{{route('admin.subcategory')}}">Sub Category</a>
            </li> --}}
            <li class="nav-item">
                   ...
                   <li>
                    <a class="dropdown-item" href="{{ route('admin.change.password') }}">
                       <div class="d-flex align-items-center">
                         ...
                         <div class="setting-text ms-3"><span>Changes Password</span></div>
                       </div>
                     </a>
                  </li>
                  {{-- <li>
                 ...
                 <div class="row row-cols-3 gx-2">
                    <div class="col">
                      <a href="{{route('admin.contacts')}}">
                       <div class="apps p-2 radius-10 text-center">
                          ...
                          <p class="mb-0 apps-name">Inquiry</p>
                       </div>
                      </a>
                    </div>
                    <div class="col">
                  ...
                  <div class="col">
                    ...
                    <div class="apps p-2 radius-10 text-center">
                       ...
                       <p class="mb-0 apps-name">Banner</p>
                    </div>
                    </a>
                  </div>
                  <div class="col">
                    <a href="{{route('admin.team')}}">
                     <div class="apps p-2 radius-10 text-center">
                       <div class="apps-icon-box mb-1 text-white bg-dark bg-gradient">
                        <i class="bi bi-person-workspace"></i>
                       </div>
                       <p class="mb-0 apps-name">Team</p>
                     </div>
                    </a>
                  </div>
                  <div class="col">
                ...
                <div class="header-notifications-list p-2">
                   {{-- <div class="dropdown-item bg-light radius-10 mb-1">
                    ...
                    @foreach ($contacts as $item)
                          <a class="dropdown-item" href="{{route('admin.contacts.view',$item->id)}}">
                      <div class="d-flex align-items-center">
                         <div class="notification-box"><i class="bi bi-messenger"></i></div>
                         <div class="ms-3 flex-grow-1">
                           <h6 class="mb-0 dropdown-msg-user">{{$item->inquiry}} <span class="msg-time float-end text-secondary">{{ $item->created_at->diffForHumans() }}</span></h6>
                           <small class="mb-0 dropdown-msg-text text-secondary d-flex align-items-center">{{ \Illuminate\Support\Str::words(strip_tags($item->message), 'w') }}</small>
                         </div>
                      </div>
                    </a> 
                    @endforeach
